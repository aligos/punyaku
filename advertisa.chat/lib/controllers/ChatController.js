 ...
 * Advertisa as my meteor username/module, and
 * ChatController for my controllername
 */
Namespace('Advertisa.ChatController');
 ...
 */
Advertisa.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return Advertisa.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        Advertisa.Chat.insert(doc, function(err, _id) {
            if (err) {
